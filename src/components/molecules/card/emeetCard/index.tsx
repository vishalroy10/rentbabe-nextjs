...
interface eMeetProps {
  item: IEMeetService;
  EMeetService: IEMeetService[];
  setEMeetService: React.Dispatch<React.SetStateAction<IEMeetService[]>>;
  currentValue: IEMeetService | undefined;
  uid: string | null | undefined;
  btnDisable: boolean;
}

const EMeetCard = ({ item, EMeetService = [], currentValue, setEMeetService }: eMeetProps) => {
            ...
            <Box display="flex" gap={4} justifyContent="space-between" width="100%" alignItems="flex-start">
                ...
                <CheckBox
                  ...
                  onClick={(e: React.MouseEvent<HTMLButtonElement>) => {
                    ...
                    if ((e.target as HTMLInputElement).checked) {
                      ...
                      setEMeetService(EMeetService?.filter((i: IEMeetService) => i?.id !== item?.id));
                    }
                  }}
                  checked={check}
              ...
              <Box>
                ...
                <TextareaAutosize
                  placeholder="Intro"
                  className={
                    check && (currentValue?.bio === '' || !currentValue?.bio)
                  ...
                  onChange={(e) => {
                    ...
                    setEMeetService([...EMeetService.filter((i: IEMeetService) => i?.id !== item?.id), newService]);
                  }}
                ...
                {check && (currentValue?.price === '' || !currentValue?.price) && (
